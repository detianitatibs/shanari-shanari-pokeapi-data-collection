...
| form_name_en | フォーム名(英語) | フォームの英語名                    |
| form_name_jp | フォーム名       | フォームの日本語名                  |
...
能力を変化する技について、どの能力をどれくらい変化させるかを一覧にしたマスタードメイン
...
| ---------------- | -------------- | ------------------------- |
| move_id          | 技 ID          | 技に割り振られる固有の ID |
| stat_change_num  | 能力変化値     | 何段階変化するか          |
| stat_change_name | 能力変化名     | 何の能力が変化するか      |
